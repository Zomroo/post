...
def handle_message(client, message):
    ...
    if message.text.startswith('http') or message.photo:
        link = message.text
        ...
        client.send_message(chat_id=message.chat.id, text=confirm_msg, reply_markup=keyboard, photo=photo)
...
def handle_button_click(client, callback_query):
    ...
    if callback_query.data == "confirm":
        ...
        caption = f"Link: {link}"
        client.send_message(chat_id=channel_id, text=caption, reply_markup=keyboard, photo=photo)
