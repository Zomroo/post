...
def handle_message(client, message):
    ...
    if message.caption:
        ...
        regular_text = caption_lines[0]  # Extract regular text from the first line of the caption

        # Ask for confirmation
        confirmation_message = f"Are you sure you want to send this post?"
        ...
        # Send the regular text and links as a post to the target channel
        channel_id = -1001959451716
        caption = f"Regular Text: {regular_text}\nJoin Backup Channel - https://t.me/+jUtnpvdlE9AwZTRl"
        links = caption_lines[1:]  # Exclude the regular text from the links
