...
# Variable to store text after links
text_after_links = ''
...
def handle_message(client, message):
    ...
    global text_after_links  # Use the global variable
    ...
    if message.text:
        ...
        if message.text.startswith('http'):
            ...
            # Store text after links
            text_after_links = message.text.strip()  # Remove leading/trailing whitespace
    ...
    if message.caption:
        ...
        if message.caption.startswith('http'):
            ...
            # Store text after links
            text_after_links = message.caption.strip()  # Remove leading/trailing whitespace
...
def handle_callback(client, callback_query):
    ...
    if action == 'confirm':
        ...
        if message.photo:
            ...
            if text_after_links:
                caption += '\n\n' + text_after_links  # Include text after links in caption
